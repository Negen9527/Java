...
insert  into `cinema`(`id`,`name`,`addr`,`city`) values (1,'万达','深圳南山区','深圳'),(2,'百脑汇','深圳市龙华区','深圳'),(3,'上影','南山区深南大道10000号','深圳');
...
insert  into `movie_hall`(`id`,`name`,`cinema_id`) values (1,'1号影厅',1);
